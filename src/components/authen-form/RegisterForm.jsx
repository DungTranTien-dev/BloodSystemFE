...
import {
    ...
    Select,
    Radio,
    Checkbox, // Thêm Checkbox vào import
    Row,
    Col,
    Space,
    Typography,
...
const RegisterForm = () => {
    ...
    // CSS class chung cho các nút bấm chính
    const primaryButtonClass = "!h-12 !bg-gradient-to-r !from-red-500 !to-pink-600 !text-white !font-bold hover:!opacity-90 !border-none";
        ...
        <div className="w-full max-w-4xl bg-white shadow-2xl rounded-2xl p-8 md:p-12">
            ...
            >
                ...
                <div className="mb-6">
                    ...
                    <Row gutter={16}>
                        <Col xs={24} md={12}><Form.Item name="gender" label="Giới tính" rules={[{ required: true, message: 'Chọn giới tính!' }]}><Radio.Group><Radio value="male">Nam</Radio><Radio value="female">Nữ</Radio><Radio value="other">Khác</Radio></Radio.Group></Form.Item></Col>
                        <Col xs={24} md={12}><Form.Item name="idNumber" label="Số CMND/CCCD" rules={[{ required: true, message: 'Nhập số CMND/CCCD!' }, { pattern: /^[0-9]{9,12}$/, message: 'Không hợp lệ!' }]}><Input placeholder="CMND hoặc CCCD" /></Form.Item></Col>
                    </Row>
                </div>
                ...
                {/* THÊM: Checkbox đồng ý điều khoản */}
                <Form.Item
                    name="termsAgreement"
                    ...
                    rules={[
                        {
                            validator: (_, value) =>
                                value ? Promise.resolve() : Promise.reject(new Error('Bạn phải đồng ý với điều khoản để đăng ký!')),
                        },
                    ]}
                    className="mt-6"
                >
                    <Checkbox>
                        Tôi đồng ý với <a href="/terms" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Điều khoản sử dụng</a> và <a href="/privacy" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">Chính sách bảo mật</a>.
                    </Checkbox>
                </Form.Item>

                <div className="text-center mt-8">
                    <Space size="large">
                        {/* THAY ĐỔI: Áp dụng style giống nút Đăng ký */}
                        <Button
                            size="large"
