        ...
        <div className="mx-auto max-w-5xl px-4 md:px-8">
          <div className="flex flex-col md:flex-row items-center gap-10 md:gap-16">
            ...
            <div className="flex-1 text-left md:pl-0 md:pr-6">
              ...
              <button className="px-6 py-2 rounded-lg border border-blue-300 text-blue-600 font-semibold bg-white hover:bg-blue-50 transition flex items-center gap-2">
      ...
      <div>
        ...
        {showChat && (
          <motion.div
            ...
            className="fixed z-50 bottom-24 right-6 animate-fade-in"
          >
