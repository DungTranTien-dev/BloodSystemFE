...
import { CheckCircleOutlined, CloseCircleOutlined, ClockCircleOutlined, EyeOutlined, HeartOutlined, TeamOutlined } from '@ant-design/icons';
...
const StaffDonorRequests = () => {
  ...
  const handleUpdateStatus = async (requestId, newStatus) => {
    // TODO: API call to update donor request status
    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-pink-50 to-orange-50">
      ...
      <div className="container mx-auto p-6">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-gray-600 text-lg">Xử lý và phê duyệt các yêu cầu hiến máu từ cộng đồng</p>
        </div>
